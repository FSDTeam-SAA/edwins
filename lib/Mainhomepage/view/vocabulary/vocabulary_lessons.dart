...
import 'package:language_app/Mainhomepage/view/widgets/choice_chip_widget.dart';
...
class _VocabLoopViewState extends State<VocabLoopView> with TickerProviderStateMixin {
  ...
  Future<void> _initTts() async {
    ...
    if (selectedAvatar.toLowerCase() == 'karl') {
  ...
  void _startLipSync(String text) {
    ...
    for (var word in words) {
      ...
      if (visemeMap.containsKey(lookupWord)) {
        ...
        print('📋 Available words: ${visemeMap.keys.take(10).toList()}...');
      }
    }
  }
